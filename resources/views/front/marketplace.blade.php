...
<body>
  ...
  <div class="row mp2 mx-auto">
    ...
    <div class="col-md-3 mb-5">
        ...
        <h5 class="card-title c-t-1">Fresh Cabbage</h5>
    ...
    <div class="col-md-3">
        ...
        <h5 class="card-title c-t-1">Chilly Pepper in Kilos</h5>
    ...
    <div class="col-md-3">
        ...
        <h5 class="card-title c-t-1">Broiler Chicken</h5>
    ...
    <div class="col-md-3">
        ...
        <p class="card-text ml-5">This is a wider </p>
        <div class="d-flex justify-content-center">
           <button type="submit" class="btn btn-primary col-xs-4 col-md-4 ">BUY</button>
        </div>
   </div>
